...
use Trascastro\TUserBundle\Form\UserType;
...
class UserController extends Controller
{
     ...
     * @Route(
     *     path="/",
     *     name="tuser_user_menu"
     * )
     */
    public function menuAction()
    {
        return $this->render('TUserBundle:user:menu.html.twig');
    }

    /**
     * @Route(
     *     path="/index",
     *     name="tuser_user_index"
     * )
    ...
    public function indexAction()
    {
        ...
        $repository = $m->getRepository('TUserBundle:User');

        $users = $repository->findAll();

        return $this->render('TUserBundle:user:index.html.twig',
            [
                'users' => $users,
            ]
        );
     ...
     * @Route(
     *     path="/register",
     *     name="tuser_user_register"
     * )
     */
    public function registerAction()
    {
        if ($this->isGranted('ROLE_USER')) {
            return $this->redirectToRoute('tuser_user_menu');
        }
        ...
        return $this->render('TUserBundle:user:form.html.twig',
            [
                'form'      => $form->createView(),
                'action'    => $this->generateUrl('tuser_user_doRegister'),
                'register'  => true,
            ]
        );
    }
    ...
    public function insertAction()
    {
        ...
        return $this->render('TUserBundle:user:form.html.twig',
            [
                'form'      => $form->createView(),
                'action'    => $this->generateUrl('tuser_user_doInsert'),
                'register'  => false,
            ]
        );
    }
    ...
    public function doInsertAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirectToRoute('tuser_user_index');
        }
    ...
    public function updateAction($id)
    {
        ...
        return $this->render('TUserBundle:user:form.html.twig',
            [
                'form'      => $form->createView(),
                'action'    => $this->generateUrl('tuser_user_doUpdate', ['id' => $id]),
                'register'  => false,
            ]
        );
    }
